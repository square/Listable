...
public protocol BlueprintHeaderFooterElement: HeaderFooterElement
where Appearance == BlueprintHeaderFooterElementAppearance {
  //
...
extension Listable.HeaderFooter where Element: BlueprintHeaderFooterElement {
  public init(
...
extension BlueprintHeaderFooterElement {
  public func apply(to view: Appearance.ContentView, reason: ApplyReason) {
...
public struct BlueprintHeaderFooterElementAppearance: HeaderFooterElementAppearance {
  ...
  public func isEquivalent(to other: BlueprintHeaderFooterElementAppearance) -> Bool {
    return true
  }
}
