...
class TableListLayoutTests: XCTestCase {
    func test_naturalWidth_vertical() {
        let list = listProperties(direction: .vertical, includeHeader: true, stickyListHeader: false)
    ...
    func test_naturalWidth_horizontal() {
        let list = listProperties(direction: .horizontal, includeHeader: true, stickyListHeader: false)
    ...
    func test_layout_vertical_includingHeader() {
        let listView = list(direction: .vertical, includeHeader: true)
    ...
    func test_layout_vertical_stickyHeader() {
        let listView = list(direction: .vertical, includeHeader: true, stickyListHeader: true)
    ...
    func test_layout_vertical_excludingHeader() {
        let listView = list(direction: .vertical, includeHeader: false)
    ...
    func test_layout_horizontal_includingHeader() {
        let listView = list(direction: .horizontal, includeHeader: true)
    ...
    func test_layout_horizontal_excludingHeader() {
        let listView = list(direction: .horizontal, includeHeader: false)
    ...
    func test_layout_horizontal_stickyHeader() {
        let listView = list(direction: .horizontal, includeHeader: true, stickyListHeader: true)
    ...
    func list(direction: LayoutDirection, includeHeader: Bool, stickyListHeader: Bool = false) -> ListView
    {
        ...
        listView.configure(
            with: listProperties(direction: direction, includeHeader: includeHeader, stickyListHeader: stickyListHeader)
        )
