...
class SectionedDiffTests: XCTestCase {
    func test_section_changes() {
        ...
        testcase("test_added_items_in_added_section") {
            let old = [
        ...
        testcase("test_added_items_in_no_change_section") {
            let old = [
                Section(identifier: 0, items: [0, 1]),
            ]
        ...
        testcase("test_added_items_in_moved_section") {
            let old = [
                Section(identifier: 0, items: [0, 1]),
        ...
        testcase("test_moving_item_is_not_added") {
            let old = [
        ...
        func makeDiff(old: [Section], new: [Section]) -> SectionedDiff<Section, Int, Int, Int> {
            SectionedDiff<Section, Int, Int, Int>.init(
                old: old,
                new: new,
                configuration: .init(
                    section: .init(
