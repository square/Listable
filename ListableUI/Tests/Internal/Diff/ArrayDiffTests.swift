...
class ArrayDiffTests: XCTestCase {
    ...
    func test_move_and_update() {
        ...
        testcase("Update and moved items") {
            let old = ["a", "b", "c", "d"]
            let new = ["A", "c", "d", "B"]
    ...
    func test_insert_and_remove_duplicate_items() {
        testcase("Insert duplicate items") {
            let old = ["a", "b", "c", "d"]
        ...
        testcase("Remove duplicate items") {
    ...
    func test_transform_with_random_mutations() {
        ...
        testcase("Shuffling, Removing, and Inserting elements") {
            for _ in 1 ... iterations {
                let old = Self.numbers
                var new = Self.numbers
