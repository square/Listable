...
class ReusableViewCacheTests: XCTestCase {
    func test_push_pop() {
        testcase("Pop with no view calls create") {
        ...
        testcase("Pop with view does not call create") {
            let cache = ReusableViewCache()
        ...
        testcase("Pop removes last view pushed") {
            let cache = ReusableViewCache()
    ...
    func test_use() {
        testcase("Use with no view calls create") {
            let cache = ReusableViewCache()
        ...
        testcase("Use with view does not call create") {
            let cache = ReusableViewCache()
        ...
        testcase("Use removes last view pushed") {
            let cache = ReusableViewCache()
...
private final class TestView1: UIView {
    var identifier: String = ""
}

private final class TestView2: UIView {
    var identifier: String = ""
}
