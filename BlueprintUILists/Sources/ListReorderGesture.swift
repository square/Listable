...
public struct ListReorderGesture : Element
{
    ...
    /// This will provide a richer VoiceOver utterance useful for disambiguation between items.
    ...
    public init(
        ...
        self.reorderItemAccessibilityLabel = reorderItemAccessibilityLabel
...
public extension Element
{
    ...
    func listReorderGesture(
        ...
        ListReorderGesture(isEnabled: isEnabled,
                           actions: actions,
                           begins: begins,
                           reorderItemAccessibilityLabel: reorderItemAccessibilityLabel,
                           wrapping: self)
    }
}
