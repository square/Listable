...
public extension BlueprintItemContent {
    ...
    func apply(to views: ItemContentViews<Self>, for _: ApplyReason, with info: ApplyItemContentInfo)
    {
        views.content.element = element(with: info).wrapInBlueprintEnvironmentFrom(environment: info.environment)
        views.background.element = backgroundElement(with: info)?.wrapInBlueprintEnvironmentFrom(environment: info.environment)
        views.selectedBackground.element = selectedBackgroundElement(with: info)?.wrapInBlueprintEnvironmentFrom(environment: info.environment)
    }
