...
public struct Section {
  ...
  public typealias Build = (inout Section) -> Void
  ...
  where Element.Appearance == Element {
...
extension SectionInfo {
  ...
  public func anyWasMoved(comparedTo other: AnySectionInfo) -> Bool {
...
extension Section {
  public func elementsEqual(to other: Section) -> Bool {
