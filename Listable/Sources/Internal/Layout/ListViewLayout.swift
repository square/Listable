...
protocol ListViewLayoutDelegate: AnyObject {
  ...
  func heightForItem(
    at indexPath: IndexPath, in collectionView: UICollectionView, width: CGFloat,
  ...
  func heightForListHeader(
    in collectionView: UICollectionView, width: CGFloat, layoutDirection: LayoutDirection
  ) -> CGFloat
  ...
  func heightForHeader(
    in sectionIndex: Int, in collectionView: UICollectionView, width: CGFloat,
    layoutDirection: LayoutDirection
  ) -> CGFloat
  func layoutForHeader(in sectionIndex: Int, in collectionView: UICollectionView)
    -> HeaderFooterLayout
  ...
  func layoutForFooter(in sectionIndex: Int, in collectionView: UICollectionView)
    -> HeaderFooterLayout
...
class ListViewLayout: UICollectionViewLayout {
  ...
  override func invalidateLayout(with context: UICollectionViewLayoutInvalidationContext) {
    ...
    if let from = context.previousIndexPathsForInteractivelyMovingItems,
    ...
    context.widthChanged = self.layoutResult.shouldInvalidateLayoutFor(
      newCollectionViewSize: view.bounds.size)
  ...
  override func initialLayoutAttributesForAppearingItem(at itemIndexPath: IndexPath)
    -> UICollectionViewLayoutAttributes?
  {
    let wasInserted = self.changesDuringCurrentUpdate.insertedItems.contains(
      .init(newIndexPath: itemIndexPath))
    ...
    if wasInserted {
      ...
      let wasSectionInserted = self.changesDuringCurrentUpdate.insertedSections.contains(
        .init(newIndex: itemIndexPath.section))
  ...
  override func finalLayoutAttributesForDisappearingItem(at itemIndexPath: IndexPath)
    -> UICollectionViewLayoutAttributes?
  {
    let wasItemDeleted = self.changesDuringCurrentUpdate.deletedItems.contains(
      .init(oldIndexPath: itemIndexPath))
    ...
    if wasItemDeleted {
      ...
      let wasSectionDeleted = self.changesDuringCurrentUpdate.deletedSections.contains(
        .init(oldIndex: itemIndexPath.section))
  ...
  override func initialLayoutAttributesForAppearingSupplementaryElement(
    ...
    let wasInserted = self.changesDuringCurrentUpdate.insertedSections.contains(
      .init(newIndex: elementIndexPath.section))
    let attributes = super.initialLayoutAttributesForAppearingSupplementaryElement(
      ofKind: elementKind, at: elementIndexPath)
  ...
  override func finalLayoutAttributesForDisappearingSupplementaryElement(
    ...
    let wasDeleted = self.changesDuringCurrentUpdate.deletedSections.contains(
      .init(oldIndex: elementIndexPath.section))
  ...
  override func layoutAttributesForInteractivelyMovingItem(
    at indexPath: IndexPath, withTargetPosition position: CGPoint
  ) -> UICollectionViewLayoutAttributes {
