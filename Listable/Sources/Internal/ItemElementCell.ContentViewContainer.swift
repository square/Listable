...
extension ItemElementCell {
  final class ContentContainerView: UIView, SwipeControllerDelegate {
    ...
    private func setFrames(
      swipeController: SwipeController<Element.SwipeActionsAppearance>,
      swipeView: Element.SwipeActionsAppearance.ContentView
    ) {
    ...
    public func registerSwipeActionsIfNeeded(
      actions: SwipeActions, appearance: Element.SwipeActionsAppearance
    ) {
