...
public struct Content {
  ...
  public typealias Build = (inout Content) -> Void
...
extension Content {
  public func elementsEqual(to other: Content) -> Bool {
  ...
  struct Slice {
    ...
    enum UpdateReason: Equatable {
      ...
      var animated: Bool {
        ...
        case .contentChanged(let animated, let identifierChanged):
          return animated && identifierChanged == false
