...
public struct Appearance: Equatable {
  ...
  public init(_ configure: (inout Appearance) -> Void) {
    self.init()
  ...
  public mutating func set(with block: (inout Appearance) -> Void) {
    var edited = self
    block(&edited)
    self = edited
  }
...
public struct ListSizing: Equatable {
  ...
  public mutating func set(with block: (inout ListSizing) -> Void) {
    var edited = self
    block(&edited)
    self = edited
  }
...
public struct ListLayout: Equatable {
  ...
  public mutating func set(with block: (inout ListLayout) -> Void) {
    var edited = self
    block(&edited)
    self = edited
  }
