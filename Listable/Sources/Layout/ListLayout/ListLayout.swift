...
public extension ListLayout
{
    ...
    func updateHeaderPositions(in collectionView : UICollectionView) -> Bool
    {
        ...
        let direction = self.content.direction
...
public final class ListLayoutContent
{
    ...
    init()
    {
        ...
        self.header = SupplementaryItemInfo.empty(.listHeader, direction: .vertical)
        self.footer = SupplementaryItemInfo.empty(.listFooter, direction: .vertical)
        self.overscrollFooter = SupplementaryItemInfo.empty(.overscrollFooter, direction: .vertical)
