...
public struct Item<Element: ItemElement>: AnyItem {
  ...
  public typealias OnSelect = (Element) -> Void
  public var onSelect: OnSelect?

  public typealias OnDeselect = (Element) -> Void
  public var onDeselect: OnDeselect?

  public typealias OnDisplay = (Element) -> Void
  public var onDisplay: OnDisplay?

  public typealias OnEndDisplay = (Element) -> Void
  ...
  public typealias Build = (inout Item) -> Void
  ...
  public init(
    ...
    assert(
      (swipeActions != nil) == (swipeActionsAppearance != nil),
...
extension Item where Element.Appearance == Element {
  public init(
    with element: Element,
    sizing: Sizing = .default,
    layout: ItemLayout = ItemLayout(),
...
public struct Reordering {
  ...
  public typealias DidReorder = (Result) -> Void
...
extension Item where Element: Equatable {
  public func elementEqual(to other: Item<Element>) -> Bool {
    return self.element == other.element
  }
}

extension Array where Element == AnyItem {
  public func elementsEqual(to other: [AnyItem]) -> Bool {
