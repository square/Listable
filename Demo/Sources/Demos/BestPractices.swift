...
private struct ExampleHeader: Equatable, BlueprintHeaderFooterContent {
    var title: String
...
private struct ExampleFooter: Equatable, BlueprintHeaderFooterContent {
    var text: String
...
private struct ExampleContent: Equatable, BlueprintItemContent {
    var text: String
