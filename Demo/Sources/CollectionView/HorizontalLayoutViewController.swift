...
final class HorizontalLayoutViewController: UIViewController {
  ...
  override func loadView() {
    ...
    self.listView.setContent { list in
      ...
      list.appearance.layout.padding = UIEdgeInsets(
      ...
      list += Section(identifier: "Cards") { section in
        section += Item(
          with: CardElement(
            title: "This is the first card", detail: "Isn't it neat?", color: .white(0.95)),
          sizing: .fixed(200)
        )

        section += Item.list(identifier: "carousel", sizing: .fixed(400)) { horizontal in
          ...
          horizontal += Section(identifier: "cards") { section in
            ...
            section += Item(
              with: CardElement(
                title: "This is the first card", detail: "Isn't it neat?", color: .white(0.90)),
              sizing: .fixed(300)
            )

            section += Item(
              with: CardElement(
                title: "This is the second card", detail: "Isn't it neat?", color: .white(0.85)),
              sizing: .fixed(300)
            )

            section += Item(
              with: CardElement(
                title: "This is the third card", detail: "Isn't it neat?", color: .white(0.80)),
              sizing: .fixed(300)
            )

            section += Item(
              with: CardElement(
                title: "This is the fourth card", detail: "Isn't it neat?", color: .white(0.75)),
              sizing: .fixed(300)
            )

            section += Item(
              with: CardElement(
                title: "This is the fifth card", detail: "Isn't it neat?", color: .white(0.70)),
              sizing: .fixed(300)
            )

            section += Item(
              with: CardElement(
                title: "This is the sixth card", detail: "Isn't it neat?", color: .white(0.65)),
              sizing: .fixed(300)
            )
          }
        }
        ...
        section += Item(
          with: CardElement(
            title: "This is the second card", detail: "Isn't it neat?", color: .white(0.95)),
          sizing: .fixed(200)
        )

        section += Item(
          with: CardElement(
            title: "This is the third card", detail: "Isn't it neat?", color: .white(0.95)),
          sizing: .fixed(200)
        )
      }
    }
