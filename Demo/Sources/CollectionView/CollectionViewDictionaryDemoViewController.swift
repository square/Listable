...
final public class CollectionViewDictionaryDemoViewController: UIViewController {
  ...
  override public func loadView() {
    ...
    self.listView.set(
      source: Source(dictionary: EnglishDictionary.dictionary), initial: Source.SearchState())

    self.view = self.listView

    self.navigationItem.rightBarButtonItems = [
      UIBarButtonItem(
        title: "Scroll Down", style: .plain, target: self, action: #selector(tappedScrollDown)),
      UIBarButtonItem(
        title: "Scroll Up", style: .plain, target: self, action: #selector(tappedScrollUp)),
    ]
  }
