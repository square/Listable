...
final class FlowLayoutViewController: UIViewController {
  ...
  override func loadView() {
    ...
    self.collectionView.register(
      FlowHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
      withReuseIdentifier: "Header")
    self.collectionView.register(
      FlowFooter.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter,
