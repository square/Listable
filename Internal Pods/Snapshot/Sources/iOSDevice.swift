...
public struct iOSDevice {
  ...
  public init(
    name: String, scale: CGFloat, portraitSize: CGSize, portraitSafeAreaInsets: UIEdgeInsets
  ) {
  ...
  public static func devices(_ devices: [iOSDevice], with orientations: [UIInterfaceOrientation])
    -> [iOSDevice]
  {
...
extension Array where Element == iOSDevice {
  public func toSnapshotIterations() -> [iOSDeviceIteration] {
    return self.map {
